...
extension DropDownRow {
    ...
    * - Note: Default Animation: By default, withAnimation uses the system's default ease-in-ease-out animation. You can customize this by passing an animation parameter like .easeInOut(duration: 0.3) to withAnimation.
This modification will ensure that any UI changes that depend on the isOn state will be animated smoothly.
