...
import HybridColor
/**
 * - Description: This extension provides utility functions for 
 *                handling SwiftUI Images, including applying icon 
 *                styles and initializing images from optional system 
 *                names.
 */
extension Image {
   /**
...
extension Image {
    ...
    * - Description: This initializer creates an image from an 
                     optional system name, or returns nil if the 
                     system name is nil.
    * ## Examples:
...
/**
 * Preview
 * - Description: This section provides a preview of the image with the 
 *                applied icon style. The image is displayed in a fixed 
 *                layout with a size of 400x400. The image used for the 
 *                preview is the system image named "heart". The icon 
 *                style applied to the image includes a size of 16 and 
 *                no padding. The image is further modified with 
 *                additional padding and a background color that is 
 *                either black or white, depending on the current color 
 *                scheme.
