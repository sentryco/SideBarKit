...
/**
 * CombinedIndex
 * - Abstract: Used for selecting / deselecting items in a 2 level
 *             multi-dim UI construct
 ...
 * - Fixme: ⚠️️ Add notes regarding using uuid, and how it would change the design, and that we want to be as stateless as possible?
 * - Fixme: ⚠️️ Rename to group, item? check with copilot?
 */
